...
Plateforme type **job board / freelance** : gestion de **projets**, **propositions**, **paiements**, **forum**, **candidatures / préférences freelancer**, avec **Spring Cloud Gateway**, **Eureka**, **Keycloak (OAuth2 / JWT)** et front **Angular** (`Pi_4Sae-template`).
...
**EN (court)**  
`Spring Boot microservices: Eureka, API Gateway, Keycloak JWT, MySQL — projects, proposals, payments, forum, applications; Angular SPA.`
