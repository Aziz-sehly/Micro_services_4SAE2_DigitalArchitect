...
import { PmProjectsProgressComponent } from './projects-progress/projects-progress.component';
...
@Component({
    ...
    imports: [PmProjectsProgressComponent, ToDoListComponent, ProductDevelopmentComponent, ProjectDiscussionComponent, TeamMembersComponent, ProjectsRoadmapComponent, RunningProjectsComponent, RouterLink],
