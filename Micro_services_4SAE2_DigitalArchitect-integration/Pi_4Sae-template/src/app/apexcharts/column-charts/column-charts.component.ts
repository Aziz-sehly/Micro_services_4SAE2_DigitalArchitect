...
@Component({
    ...
    imports: [RouterLink, BasicColumnChartComponent, DataLabelsColumnChartComponent, StackedColumnChartComponent, RangeColumnChartComponent, DistributedColumnChartComponent],
