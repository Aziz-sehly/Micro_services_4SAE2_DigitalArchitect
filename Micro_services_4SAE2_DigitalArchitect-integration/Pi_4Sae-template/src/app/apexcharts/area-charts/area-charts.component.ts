...
@Component({
    ...
    imports: [RouterLink, BasicAreaChartComponent, SplineAreaChartComponent, NegativeValuesAreaChartComponent, StackedAreaChartComponent, GithubStyleAreaChartComponent],
